  ...
  admin: {
    ...
    accounts: {
      ...
      automation: {
        title: '账号自动化',
        open: '账号自动化',
        description: '集中处理状态为错误且命中 token_expired 的 OpenAI OAuth 账号。仅支持已保存邮箱和密码的账号；若已配置 FreeMail 与 HeroSMS，可自动完成邮箱 OTP 和 add_phone 手机验证。',
        reload: '刷新列表',
        refresh: '批量刷新 Token',
        refreshing: '批量刷新中...',
        empty: '当前没有可自动处理的 token 失效账号',
    ...
    settings: {
      ...
      defaults: {
        ...
        openaiOAuthFreemailDomain: 'OpenAI OAuth FreeMail 默认域名',
        openaiOAuthFreemailDomainPlaceholder: '例如：webcode.team',
        openaiOAuthFreemailDomainHint: '可选，仅作 FreeMail 默认域名记录与后续扩展使用。',
