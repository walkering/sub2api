export default {
  ...
  admin: {
    ...
    groups: {
      ...
      accountModelRestrictions: {
        action: 'Model Rules',
        title: 'Bulk Set Account Model Restrictions',
        impactScope: 'This updates the account itself, so the same accounts will also be affected in other groups.',
        targetCount: '{count} accounts currently bound to this group',
        openaiPassthroughHint: 'If an account has OpenAI passthrough enabled, runtime requests may still ignore the model restriction configured here.',
        emptyWhitelistHint: 'Leaving the whitelist empty clears existing restrictions and restores support for all models.',
        mappingHint: 'Mapping mode writes directly to account credentials.model_mapping and matches account bulk edit behavior.',
        submit: 'Apply to Group Accounts',
        submitting: 'Applying...',
        updated: 'Updated {success} accounts, failed {failed}',
        failed: 'Failed to bulk update account model restrictions'
      },
    ...
    accounts: {
      ...
      columns: {
        ...
        lastTokenRefreshAt: 'Last Refresh',
      ...
      allRefreshStates: 'All Refresh States',
      refreshStateSet: 'Refreshed',
      refreshStateUnset: 'Not Refreshed',
      allTestStates: 'All Test States',
      testStateSet: 'Tested',
      testStateUnset: 'Not Tested',
      privacyUnset: 'Unset',
    ...
    scheduledTests: {
      ...
      groupDialogTitle: 'Group Scheduled Tests',
      group: 'Group',
      selectGroup: 'Select Group',
      selectGroupFirst: 'Please select a group first',
      createGroupPlan: 'Create Group Plan',
      planList: 'Plan List',
      batchSize: 'Batch Size',
      offsetSeconds: 'Offset (seconds)',
      modelOptional: 'Model (optional)',
      modelOptionalHint: 'Leave empty to use the default test model',
      cronRequired: 'Cron expression is required',
      batchSizeInvalid: 'Batch size must be greater than 0',
      offsetInvalid: 'Offset must be greater than or equal to 0',
      planCreated: 'Group plan created successfully',
      planUpdated: 'Group plan updated successfully',
      planDeleted: 'Group plan deleted',
      batchOffsetSummary: 'Batch {batch} / Offset {offset}s',
      runNow: 'Run Test',
      runNowConfirm: 'Run an immediate test for group "{name}"?',
      realtimeLogs: 'Realtime Logs',
      realtimeLogsTitle: 'Realtime Logs - {name}',
      realtimeLogsHint: 'Choose a recent job to inspect progress and results',
      recentJobs: 'Recent Jobs',
      noJobs: 'No test jobs yet',
      selectJobFirst: 'Select a job to view details',
      ...
      progressSummary: '{done}/{total} completed',
      jobCreated: 'Test job created',
      jobCreateFailed: 'Failed to create test job',
