export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      batchTestFiltered: 'Batch Test',
      batchTestFilteredFailed: 'Failed to load accounts for batch test',
      batchTestEmpty: 'No accounts match the current filters',
      searchAccounts: 'Search accounts...',
      searchPlanType: 'Filter by plan type...',
      notes: 'Notes',
      openaiEmailProvider: 'Email Provider',
      openaiEmailProviderHint: 'Associate an email OTP provider with this OpenAI OAuth account. Connection settings are configured globally in System Settings.',
      openaiEmailProviderNone: 'None',
      openaiEmailProviderFreemail: 'FreeMail',
      openaiPhoneProvider: 'Phone Provider',
      openaiPhoneProviderHint: 'Associate a phone OTP provider with this OpenAI OAuth account. HeroSMS connection settings are configured globally in System Settings.',
      openaiPhoneProviderNone: 'None',
      openaiPhoneProviderHeroSMS: 'HeroSMS',
      openaiStoredPassword: 'Login Password',
      openaiStoredPasswordPlaceholder: 'Leave blank to use the system default password if configured',
      openaiStoredPasswordHint: 'Used only to store the OpenAI OAuth automatic re-login password. It will not be auto-filled.',
      ...
      automation: {
        ...
        open: 'Account Automation',
        description: 'Handle OpenAI OAuth accounts in bulk. Only accounts whose email domain matches the FreeMail available domain list are shown here; accounts with stored email and password are supported, and when FreeMail and HeroSMS are configured, email OTP and add-phone verification can be completed automatically.',
        reload: 'Reload List',
        refresh: 'Batch Refresh Token',
        refreshing: 'Refreshing...',
        empty: 'No automation-ready accounts match the FreeMail available domain list right now.',
        selected: '{count} account(s) selected',
        missingSelection: 'Please select at least one account to process',
        completed: 'Automation finished: {success} succeeded, {failed} failed, {skipped} skipped',
        partial: 'Automation partially finished: {success} succeeded, {failed} failed, {skipped} skipped',
        failed: 'Account automation failed',
        proxyEnabled: 'Enable Custom Proxy',
        proxyEndpoint: 'Proxy Endpoint',
        proxyPlaceholder: '127.0.0.1:7890',
        proxyHint: 'When enabled, this automation run will use the same proxy for OpenAI and email OTP requests.',
        logs: 'Live Logs',
        logsEmpty: 'Realtime execution logs will appear here after the job starts.',
        summary: {
          total: 'Total',
          success: 'Success',
          failed: 'Failed',
      ...
      testPromptPlaceholder: 'Example: hi, or please reply briefly: connection test succeeded.',
      testPromptHint: 'Customize the prompt sent to the upstream model; leave empty to use the default test prompt.',
      testPromptDefault: 'hi',
    ...
    settings: {
      ...
      defaults: {
        ...
        openaiOAuthDefaultPassword: 'OpenAI OAuth Default Password',
        openaiOAuthDefaultPasswordPlaceholder: 'Provide a fallback password for new OpenAI OAuth accounts that do not specify one',
        openaiOAuthDefaultPasswordHint: 'Used only when creating new OpenAI OAuth accounts to store auto re-login credentials. The input will not auto-fill.',
        openaiOAuthDefaultPasswordConfiguredPlaceholder: 'Configured already, leave empty to keep unchanged',
        openaiOAuthDefaultPasswordConfiguredHint: 'A default password is already configured. Leave this blank to keep it, and it only applies when a new OpenAI OAuth account is created without a password.',
        openaiOAuthFreemailBaseUrl: 'OpenAI OAuth FreeMail Base URL',
        openaiOAuthFreemailBaseUrlPlaceholder: 'https://freemail.walker-feng.workers.dev',
        openaiOAuthFreemailBaseUrlHint: 'Used to poll the FreeMail inbox when OpenAI OAuth automatic re-login triggers an email OTP challenge.',
        openaiOAuthFreemailUsername: 'OpenAI OAuth FreeMail Username',
        openaiOAuthFreemailUsernamePlaceholder: 'Enter the FreeMail login username',
        openaiOAuthFreemailPassword: 'OpenAI OAuth FreeMail Password',
        openaiOAuthFreemailPasswordPlaceholder: 'Enter the FreeMail login password',
        openaiOAuthFreemailPasswordHint: 'Used only for automatic email OTP polling. It will not be auto-filled elsewhere.',
        openaiOAuthFreemailPasswordConfiguredPlaceholder: 'Configured already, leave empty to keep unchanged',
        openaiOAuthFreemailPasswordConfiguredHint: 'A FreeMail password is already configured. Leave this blank to keep it; it is used only for automatic email OTP completion.',
        openaiOAuthFreemailDomain: 'OpenAI OAuth FreeMail Available Domains',
        openaiOAuthFreemailDomainPlaceholder: 'For example: webcode.team,mail.example.com',
        openaiOAuthFreemailDomainHint: 'Separate multiple domains with commas. The first domain is used as the default domain, and account automation only shows and processes accounts whose email domain is in this list.',
        openaiOAuthEmailOTPAdvanced: 'OpenAI OAuth Email OTP Advanced Settings',
        openaiOAuthEmailOTPPollIntervalMsPlaceholder: 'Email OTP poll interval (ms)',
        openaiOAuthEmailOTPResendAfterSecondsPlaceholder: 'Email OTP resend timeout (seconds)',
        openaiOAuthEmailOTPPollAttemptsPlaceholder: 'Email OTP attempts per round',
        openaiOAuthEmailOTPAdvancedHint: 'Controls OpenAI OAuth email OTP polling interval, resend timeout, and the number of polling attempts per round.',
        openaiOAuthPhoneBaseUrl: 'OpenAI OAuth HeroSMS Base URL',
        openaiOAuthPhoneBaseUrlPlaceholder: 'https://hero-sms.com/stubs/handler_api.php',
        openaiOAuthPhoneBaseUrlHint: 'Used to acquire phone numbers and poll SMS codes from HeroSMS when OpenAI OAuth automatic re-login enters add-phone.',
        openaiOAuthPhoneApiKey: 'OpenAI OAuth HeroSMS API Key',
        openaiOAuthPhoneApiKeyPlaceholder: 'Enter the HeroSMS API key',
        openaiOAuthPhoneApiKeyHint: 'Used only for automatic phone OTP completion. It will not be auto-filled elsewhere.',
        openaiOAuthPhoneApiKeyConfiguredPlaceholder: 'Configured already, leave empty to keep unchanged',
        openaiOAuthPhoneApiKeyConfiguredHint: 'A HeroSMS API key is already configured. Leave this blank to keep it; it is used only for automatic phone OTP completion.',
        openaiOAuthPhoneServiceCode: 'OpenAI OAuth HeroSMS Service Code',
        openaiOAuthPhoneServiceCodePlaceholder: 'For example: OpenAI',
        openaiOAuthPhoneCountry: 'OpenAI OAuth HeroSMS Country ID',
        openaiOAuthPhoneCountryPlaceholder: 'For example: 52',
        openaiOAuthPhoneOperator: 'OpenAI OAuth HeroSMS Operator',
        openaiOAuthPhoneOperatorPlaceholder: 'Optional, separate multiple operators with commas',
        openaiOAuthPhoneMaxPrice: 'OpenAI OAuth HeroSMS Max Price',
        openaiOAuthPhoneMaxPricePlaceholder: '0 means unlimited',
        openaiOAuthPhoneAdvanced: 'OpenAI OAuth Phone OTP Advanced Options',
        openaiOAuthPhoneFixedPrice: 'Fixed-price purchase',
        openaiOAuthPhoneLeaseMinutesPlaceholder: 'Lease minutes, default 20',
        openaiOAuthPhonePollIntervalMsPlaceholder: 'SMS polling interval in ms, default 5000',
        openaiOAuthPhoneResendAfterSecondsPlaceholder: 'Seconds before requesting resend, default 30',
        openaiOAuthPhoneAdvancedHint: 'These parameters control HeroSMS number acquisition, SMS polling, and resend timing.',
