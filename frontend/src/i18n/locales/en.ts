  ...
  admin: {
    ...
    accounts: {
      ...
      automation: {
        ...
        description: 'Handle OpenAI OAuth accounts in error status that match token_expired. Accounts with stored email and password are supported; when FreeMail and HeroSMS are configured, email OTP and add-phone verification can be completed automatically.',
        reload: 'Reload List',
        refresh: 'Batch Refresh Token',
        refreshing: 'Refreshing...',
        empty: 'No token-expired accounts can be handled automatically right now.',
    ...
    settings: {
      ...
      defaults: {
        ...
        openaiOAuthFreemailDomain: 'OpenAI OAuth FreeMail Default Domain',
        openaiOAuthFreemailDomainPlaceholder: 'For example: webcode.team',
        openaiOAuthFreemailDomainHint: 'Optional. Stored as the preferred FreeMail domain for future extension use.',
