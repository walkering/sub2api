...
func TestAPIContracts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "PUT /api/v1/admin/settings returns linuxdo bonus settings",
			setup: func(t *testing.T, deps *contractDeps) {
				t.Helper()
				deps.settingRepo.SetAll(map[string]string{
					service.SettingKeyRegistrationEnabled:              "true",
					...
					service.SettingKeyTurnstileSiteKey:   "",
					...
					service.SettingKeyLinuxDoConnectGiftSubs:    "[]",
					service.SettingKeyLinuxDoAutoCheckinBonus:   "false",

					service.SettingKeyEnableModelFallback:      "false",
					service.SettingKeyFallbackModelAnthropic:   "claude-3-5-sonnet-20241022",
					service.SettingKeyFallbackModelOpenAI:      "gpt-4o",
					service.SettingKeyFallbackModelGemini:      "gemini-2.5-pro",
					service.SettingKeyFallbackModelAntigravity: "gemini-2.5-pro",
					...
					service.SettingKeyEnableMetadataPassthrough:    "false",
				})
			},
			...
			body: `{
				...
				"linuxdo_connect_redirect_url": "",
				"linuxdo_connect_auto_checkin_bonus_enabled": true,
				"linuxdo_connect_gift_subscriptions": [
					{"group_id": 31, "validity_days": 14},
					{"group_id": 32, "validity_days": 30}
				],
				"site_name": "Sub2API",
				"site_logo": "",
				"site_subtitle": "Subtitle",
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	v1Admin.PUT("/settings", adminSettingHandler.UpdateSettings)
...
func (s *stubAccountRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode, refreshStatus, testStatus string) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
