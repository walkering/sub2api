...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	linuxDoAutoCheckinRewardRepository := repository.NewLinuxDoAutoCheckinRewardRepository(client, db)
	authService := service.ProvideAuthService(client, userRepository, redeemCodeRepository, refreshTokenCache, configConfig, settingService, emailService, turnstileService, emailQueueService, promoService, subscriptionService, linuxDoAutoCheckinRewardRepository)
	...
	accountTestJobRepository := repository.NewAccountTestJobRepository(db)
	scheduledTestService := service.ProvideScheduledTestService(scheduledTestPlanRepository, scheduledTestResultRepository, accountTestJobRepository, accountRepository, groupRepository, accountTestService, rateLimitService)
